...
#
# caesar = registry.get_encryptor("caesar")
# xor = registry.get_encryptor("xor")
# fernet = registry.get_encryptor("fernet")
#
# # استخدام pipe
# pipeline1 = caesar | xor | fernet
#
# # استخدام ROR
# pipeline2 = xor | caesar
# pipeline2 = fernet | pipeline2
#
# print(pipeline1)
# print(pipeline2)
#
# manager_pipe = EncFileManager("vault_pipe", encryptor=pipeline1)
#
# manager_pipe.add_file("test.txt", "Hello Pipeline")
# print(manager_pipe.read_file("test.txt"))
